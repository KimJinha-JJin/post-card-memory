...
private fun patternColorFor(
    backgroundColorArgb: Long
): Color {
    val packedColor = backgroundColorArgb.toInt()
    val red = (packedColor shr 16) and 0xFF
    val green = (packedColor shr 8) and 0xFF
    val blue = packedColor and 0xFF
...
private fun DrawScope.drawPostcardPattern(
    ...
    val horizontalCount =
        (size.width / cellSize).toInt() + 3
    val verticalCount =
        (size.height / cellSize).toInt() + 3
...
private fun DrawScope.drawCheckerPattern(
    ...
    val horizontalCount =
        (size.width / tileSize).toInt() + 2
    val verticalCount =
        (size.height / tileSize).toInt() + 2
